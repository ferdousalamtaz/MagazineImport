...
namespace MagazineImport.Code.Mapping
{
    public class PrenaxMapper : MagazineMapperDefaults
    {
        ...
        public readonly string StrFilePrefix;
        ...
        public PrenaxMapper(DataRow dr, string strFileName, string filePrefix)
        {
            FileName = strFileName;
            DataSource = dr;
            StrFilePrefix = filePrefix;
        }
        ...
        public override int CountryId
        {
            get
            {
                if (FileName.StartsWith(StrFilePrefix + "se_"))
                    return 1;
                if (FileName.StartsWith(StrFilePrefix + "no_"))
                    return 2;
                if (FileName.StartsWith(StrFilePrefix + "fi_"))
                    return 13;
                if (FileName.StartsWith(StrFilePrefix + "al_"))
                    return 35;
